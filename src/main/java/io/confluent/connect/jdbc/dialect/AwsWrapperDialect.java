...
/**
 * A {@link DatabaseDialect} for Aws Aurora Mysql -
...
public class AwsWrapperDialect extends GenericDatabaseDialect {
  ...
  protected String getSqlType(SinkRecordField field) {
    if (field.schemaName() != null) {
      String name = handleSchemaName(field);
      if (name != null) {
        return name;
      }
    }
    return handleSchemaType(field);
  }

  private String handleSchemaType(SinkRecordField field) {
  ...
  private String handleSchemaName(SinkRecordField field) {
