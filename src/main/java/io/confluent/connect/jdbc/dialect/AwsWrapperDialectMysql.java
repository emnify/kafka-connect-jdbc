...
/**
 * A {@link DatabaseDialect} for Aws Aurora Mysql - mysql dialect would be normally sufficient, but it seems that it supports only a single driver
 */
public class AwsWrapperDialectMysql extends GenericDatabaseDialect {
    ...
    public static class Provider extends DatabaseDialectProvider.SubprotocolBasedProvider {
        public Provider() {
            super(AwsWrapperDialectMysql.class.getSimpleName(), "aws-wrapper:mysql", "aws-wrapper:postgres");
        }
